    ...
    <div className="flex-1 overflow-y-auto p-3 select-none flex flex-col gap-2 font-sans text-xs">
      ...
      >
        <div className="flex items-center gap-2">
          <span
            className="font-black px-2 py-0.5 rounded-lg text-white text-[11px] shadow-2xs"
            style={{ backgroundColor: statusColor }}
          >
            {response.statusCode}
          </span>
          <span className="font-bold text-gray-800 dark:text-gray-200 text-xs font-sans">
